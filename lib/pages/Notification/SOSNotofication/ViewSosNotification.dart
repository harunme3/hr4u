...
class ViewNotoficationsos extends StatefulWidget {
  final int? id;
  const ViewNotoficationsos({super.key, required this.id});

  @override
  State<ViewNotoficationsos> createState() => _ViewNotoficationsosState();
}

class _ViewNotoficationsosState extends State<ViewNotoficationsos> {
